...
let boy=setInterval(() => {
    ...
    if(s=="./images/img1.png"){
        b_img.src="./images/img2.png"
    }
    else if(s=="./images/img2.png"){
        b_img.src="./images/img3.png"
    }
    else if(s=="./images/img3.png"){
        b_img.src="./images/img4.png"
    }
    else if(s=="./images/img4.png"){
        b_img.src="./images/img1.png"
    }
},250)

setTimeout(() => {
    clearInterval(boy)
    b_img.src="./images/img5.png"
...
setTimeout(() => {
    let girl=setInterval(() => {
        ...
        if(s=="./images/g_img1.png"){
            g_img.src="./images/g_img2.png"
        }
        else if(s=="./images/g_img2.png"){
            g_img.src="./images/g_img3.png"
        }
        else if(s=="./images/g_img3.png"){
            g_img.src="./images/g_img4.png"
        }
        else if(s=="./images/g_img4.png"){
            g_img.src="./images/g_img5.png"
        }
    },150)
